...
import { BookOpen, Download, FileText, Languages, Lightbulb, ListTree, MoonStar } from 'lucide-react';
    ...
    <div className="flex-1 bg-surface">
      <header className="container mx-auto px-4 md:px-6 py-4 flex justify-between items-center">
        <div className="flex items-center gap-3">
          ...
          <span className="text-2xl font-semibold text-ink">Pustaka Cepat</span>
        </div>
        <nav className="hidden md:flex gap-6 items-center text-sm font-medium">
          <a href="#" className="text-ink-muted hover:text-primary transition-colors">Fitur</a>
          <a href="#" className="text-ink-muted hover:text-primary transition-colors">Harga</a>
          <a href="#" className="text-ink-muted hover:text-primary transition-colors">Demo</a>
        </nav>
        <div className="flex gap-2">
          <Button variant="ghost">Login</Button>
          <Button variant="secondary" className="rounded-full">Daftar</Button>
        </div>
      </header>
      ...
      <section className="bg-surface-muted py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl font-bold text-center mb-12 text-ink">Alur Kerja Cerdas dalam 5 Langkah</h2>
      ...
      <section className="container mx-auto px-4 md:px-6 py-16 md:py-24">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <Card className="p-6">
            ...
            <p className="text-sm text-ink-muted mb-2">Bab 3: Etika Kecerdasan Buatan</p>
          ...
          <Card className="p-6">
            ...
            <p className="text-sm text-ink-muted mb-2">Contoh penyisipan dalil.</p>
            <div className="space-y-4 text-sm text-ink-muted leading-relaxed">
              <p>
              ...
              <div className="bg-surface-muted p-4 rounded-lg border text-right">
                <p className="font-arabic text-xl text-ink leading-loose" dir="rtl">
      ...
      <footer className="bg-ink text-white mt-auto">
        <div className="container mx-auto px-4 md:px-6 py-8 text-center text-sm">
